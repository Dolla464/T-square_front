...
function AllTeam() {
  ...
  return (
    <div className="team-page">
      ...
      <div className="py-5 mt-5">
        <Container>
          ...
          <Row className="g-4 mb-5 pb-4">
            {teamData.map((member) => (
              <Col lg={3} md={6} sm={6} key={member.id}>
                <div className="team-card">
                  ...
                  <div className="member-info text-center">
                    <h5 className="member-name fw-bold mb-1">{member.name}</h5>
                    <p className="member-role text-muted mb-3">{member.role}</p>
                    ...
                    <div className="social-links d-flex justify-content-center gap-2">
                      ...
                      <a href={member.socials.facebook} className="social-icon">
      ...
      <div className="cta-journey-section text-center text-white py-5">
