...
function InstructorQuizzes() {
  ...
  const { courses, getCourses, loading: coursesLoading } = useInstructorCourses();
  ...
  const handleEdit = async (item) => {
    ...
    if (fullData) {
      ...
      setFormData({
        ...
        shuffle_questions:
          fullData.shuffle_questions !== undefined
            ? fullData.shuffle_questions
            : true,
        questions_per_attempt: fullData.questions_per_attempt || "",
      });
      setShowForm(true);
    }
  };
  ...
  const handleSubmit = async (e) => {
    ...
    const payload = {
      ...formData,
      course_name: selectedCourseObj
        ? selectedCourseObj.title || selectedCourseObj.name
        : "Custom Course",
    };
      ...
      {!showForm ? (
          ...
          <div className="ac-header d-flex justify-content-between align-items-center mb-4">
            <div>
              <h2 className="ac-title">
                {showTrash
                  ? t("quizzes_page.trash_title")
                  : t("quizzes_page.title")}
              </h2>
            ...
            <div className="d-flex gap-2">
              ...
              >
                ...
                <span className="d-none d-md-inline">
                  {showTrash
                    ? t("quizzes_page.back_to_active")
                    : t("quizzes_page.trash")}
                </span>
              </button>
            </div>
          </div>
              ...
              <div className="ac-rounded-table p-3 p-md-0">
                ...
                <div className="ac-filters-bar d-flex justify-content-between align-items-center mb-3 flex-wrap gap-3">
                  ...
                  <section className="d-flex flex-column flex-md-row gap-2 gap-md-3 w-100 w-md-auto">
                    ...
                    >
                      <option value="all">{t("quizzes_page.all_time")}</option>
                    ...
                    <thead>
                      <tr>
                        <th className="text-center">
                          {t("quizzes_page.table_title")}
                        </th>
                        <th className="text-center">
                          {t("quizzes_page.table_course")}
                        </th>
                        <th className="text-center">
                          {t("quizzes_page.table_questions_count")}
                        </th>
                        <th className="text-center">
                          ...
                          <tr key={quizItem.id}>
                            ...
                            <td className="text-center">
                              {showTrash ? (
                                ...
                                <span
                                  className={`badge rounded-pill ${quizItem.status === "active" ? "bg-success-subtle text-success" : "bg-danger-subtle text-danger"}`}
                                  style={{
                                    cursor: "pointer",
                                    padding: "8px 16px",
                                  }}
                                ...
                                >
                                  <i
                                    className={`bi ${quizItem.status === "active" ? "bi-check-circle" : "bi-pause-circle"} me-1 small`}
                                  ></i>
                                ...
                                {showTrash ? (
                                  ...
                                  <>
                                    <button
                                      ...
                                      onClick={() =>
                                        navigate(`view-exam/${quizItem.id}`)
                                      }
                                    >
        ...
        <div className="ac-form-container">
          <div className="ac-form-header d-flex justify-content-between align-items-center mb-4">
            <button
              className="ac-back-btn border-0 bg-transparent d-flex align-items-center"
              onClick={handleBack}
            >
              <i
          ...
          <div
            className="ac-form-body p-4 bg-white border rounded-4 shadow-sm"
            dir={isArabic ? "rtl" : "ltr"}
          >
            <form onSubmit={handleSubmit}>
              <div className="ac-tab-content basic-info">
                {/* Quiz Title & Course Selection */}
                <div className="row mb-4">
                  ...
                  <div className="col-md-6 mb-4">
                    ...
                    <select
                      name="course_id"
                      className="form-select ac-form-select-full-width p-3 bg-light border-0 rounded-3 text-muted"
                      value={formData.course_id}
                      onChange={handleChange}
                    >
                      <option value="">
                        {t("quizzes_page.select_course")}
                      </option>
                ...
                {/* Quiz Duration, Max Attempts, Questions Per Attempt */}
                <div className="row mb-4">
                  ...
                  <div className="col-md-4 mb-3 mb-md-0">
                    <label className="form-label fw-bold text-dark">
                      {isArabic ? "أقصى عدد للمحاولات" : "Max attempts"}
                    </label>
                    <input
                      type="number"
                      name="max_attempts"
                  ...
                  <div className="col-md-4 mb-3 mb-md-0">
                    <label className="form-label fw-bold text-dark">
                      {isArabic
                        ? "عدد الأسئلة في كل محاولة"
                        : "Questions Number (questions per attempt)"}
                    </label>
                    <input
                      type="number"
                ...
                {/* Switches: Final Exam & Active Status */}
                  ...
                  <div>
                    ...
                    >
                      ...
                      <small className="text-muted">
                        {isArabic
                          ? "اجعل هذا الاختبار اختباراً نهائياً"
