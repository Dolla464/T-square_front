...
export const getLearningGroups = (params) =>
  axiosClient.get("/receptionist/learning-groups", { params }).then((res) => res.data);

// ----------------------------------------------------------------------------
// جلب المجموعات الدراسية للقوائم المنسدلة (بدون pagination)
// ----------------------------------------------------------------------------
export const getLearningGroupsSelection = (params = {}) =>
  axiosClient.get("/receptionist/learning-groups/selection", { params }).then((res) => res.data);
...
export const getLearningGroupById = (id) =>
  axiosClient.get(`/receptionist/learning-groups/${id}`).then((res) => res.data);
...
export const getAvailableStudents = (id) =>
  axiosClient
    .get(`/receptionist/learning-groups/${id}/unassigned-students`)
    .then((res) => res.data);
...
export const createLearningGroup = (payload) =>
  axiosClient
    .post("/receptionist/learning-groups", payload)
    .then((res) => res.data);
...
export const updateLearningGroup = (id, payload) =>
  axiosClient
    .put(`/receptionist/learning-groups/${id}`, payload)
    .then((res) => res.data);
...
export const deleteLearningGroup = (id) =>
  axiosClient
    .delete(`/receptionist/learning-groups/${id}`)
    .then((res) => res.data);
...
export const bulkAssignStudents = (id, payload) =>
  axiosClient
    .post(`/receptionist/learning-groups/${id}/bulk-assign`, payload)
    .then((res) => res.data);
...
export const getLearningGroupSchedule = (id) =>
  axiosClient
    .get(`/receptionist/learning-groups/${id}/schedule`)
    .then((res) => res.data);
...
export const getLearningGroupSessions = (id) =>
  axiosClient
    .get(`/receptionist/learning-groups/${id}/sessions`)
    .then((res) => res.data);
...
export const getAttendanceReport = (id, sessionId = null) => {
  ...
  return axiosClient
    .get(`/receptionist/learning-groups/${id}/attendance`, { params })
    .then((res) => res.data);
};
...
export const getSessionAttendance = (groupId, sessionId) =>
  axiosClient
    .get(`/receptionist/learning-groups/${groupId}/sessions/${sessionId}/attendance`)
    .then((res) => res.data);
...
export const markSessionAttendance = (groupId, sessionId, studentId, status, notes = null) =>
  axiosClient
    .post(`/receptionist/learning-groups/${groupId}/sessions/${sessionId}/attendance/mark`, {
...
export const exportStudentCourseAttendance = async (
  ...
  const response = await axiosClient.get(
    `/receptionist/learning-groups/${groupId}/students/${studentId}/attendance/export`,
    { params: { format } }
  );
  downloadExportBlob(response);
};
...
export const exportGroupStudents = async (id, format = "pdf") => {
  ...
  const response = await axiosClient.get(
    `/receptionist/learning-groups/${id}/students/export`,
    { params }
  );
...
export const getLearningGroupExams = (groupId) =>
  axiosClient
    .get(`/receptionist/learning-groups/${groupId}/exams`)
    .then((res) => res.data);

export const getExamResults = (groupId, examId) =>
  axiosClient
    .get(`/receptionist/learning-groups/${groupId}/exams/${examId}/results`)
    .then((res) => res.data);

export const getStudentExamResults = (groupId, studentId, examId) =>
  axiosClient
    .get(`/receptionist/learning-groups/${groupId}/students/${studentId}/exam-results`, {
...
export const getStudentAttemptReview = (groupId, studentId, attemptId) =>
  axiosClient
    .get(
      `/receptionist/learning-groups/${groupId}/students/${studentId}/exam-attempts/${attemptId}/review`,
    )
    .then((res) => res.data);

export const exportExamResults = async (groupId, examId, format = "pdf") => {
  const response = await axiosClient.get(
    `/receptionist/learning-groups/${groupId}/exams/${examId}/results/export`,
    { params: { format } }
  );
  downloadExportBlob(response);
};
